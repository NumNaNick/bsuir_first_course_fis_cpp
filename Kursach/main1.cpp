...
void addTicket() {
    ...
    while (true) {
		...
		if (cin.fail() || temp < 0 || temp > 1) {
            ...
            newTicket.is_discount_allowed = temp;
            cin.ignore();
			break;
		}
	}
...
void deleteTicket() {
    ...
    struct Ticket *allTickets = new Ticket[MAX_TICKETS];
    int count = 0;
    ...
    cout << "Выберите действие: ";
        ...
        switch(choice) {
            ...
            case 5: {
                ...
                struct Ticket *arr = new Ticket[MAX_TICKETS];
                int n = 0;
